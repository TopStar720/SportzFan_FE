...
const SuccessModal = ({ show, onClose }: ModalProps) => {
  return (
        ...
        <div className="flex justify-center items-center">
          <div className="drop-shadow-[0_0_12px_rgba(204,143,0,1)] w-full flex flex-col items-center">
            ...
            <div className="flex items-center mt-10">
              ...
              <span className="point-value font-bold text-24 leading-16 ml-2">20</span>
            </div>
          </div>
          ...
          <div className="drop-shadow-[0_0_12px_rgba(204,37,71,1)] w-full flex flex-col items-center">
            ...
            <div className="flex items-center mt-10">
              ...
              <span className="token-value font-bold text-24 leading-16 ml-2">20</span>
            </div>
          </div>
        </div>
        <div className="w-full h-20" />
        <p className="text-14 text-white leading-24 font-archivo text-center">For completing the Referrer Challenge.</p>
