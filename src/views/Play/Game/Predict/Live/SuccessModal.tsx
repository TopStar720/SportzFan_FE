  ...
  return (
    <Modal show={show} onClose={onClose}>
      <div className="w-full max-w-400 bg-sf-zinc-900 rounded-[4px] flex flex-col items-center pt-28 pb-34 px-20 sm:px-50">
        ...
        <div className="drop-shadow-[0_0_12px_rgba(204,143,0,1)] w-full flex flex-col items-center -mt-40">
          <span className="point-name text-14">You Earned</span>
        ...
        <div className="flex items-center">
          ...
          <img src={data?.sponsor?.logo} alt="" className="h-40 ml-12" />
        </div>
