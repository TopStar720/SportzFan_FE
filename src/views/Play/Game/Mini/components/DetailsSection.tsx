...
const DetailsSection = ({ title, match, start, end, eligbleKudos, rewardDistribution, sponsor, isEnded }: Mini) => {
  ...
  return (
    <div className="border border-sf-zinc-600 bg-info rounded-[4px] relative overflow-hidden">
      ...
      <div className="absolute w-full h-full flex justify-center items-center xl:justify-end">
        <img src="/assets/images/gamepad-yellow-light.svg" alt="" className="h-120 xl:mr-50" />
      </div>
