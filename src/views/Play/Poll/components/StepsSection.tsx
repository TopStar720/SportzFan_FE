...
const StepsSection = ({ description, kudosEligible, kudosReward, tokenReward }: Poll) => {
  return (
    <Fragment>
      ...
      <div className="flex items-center mt-20">
        ...
        <span className="text-12 text-sf-zinc-400 font-poppins leading-20 ml-18">
          To participate in the poll, you need to hold a minimum of {kudosEligible} kudos.
        </span>
      </div>
      <div className="flex items-center mt-20">
        <span className="hidden sm:block text-14 text-sf-yellow-300 font-poppins leading-20 whitespace-nowrap">
        ...
        <span className="text-12 text-sf-zinc-400 font-poppins leading-20 ml-18">
          Click "Vote Now" button to view and submit your choice.
        </span>
      </div>
      <div className="flex items-center mt-20">
        <span className="hidden sm:block text-14 text-sf-yellow-300 font-poppins leading-20 whitespace-nowrap">
        ...
        <span className="text-12 text-sf-zinc-400 font-poppins leading-20 ml-18">
          Your vote will count to the overall decision made. Earn {kudosReward} Kudos points just for placing your vote!
        </span>
      </div>
